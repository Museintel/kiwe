...
(async () => {
  ...
  assert(entry.contractVersion === '7.13', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '7.13', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '7.13', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 7.13', 'plan contract report mismatch');

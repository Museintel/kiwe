...
(async () => {
  ...
  assert(entry.contractVersion === '6.90', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '6.90', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '6.90', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 6.90', 'plan contract report mismatch');

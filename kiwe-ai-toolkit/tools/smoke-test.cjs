...
(async () => {
  ...
  assert(entry.contractVersion === '6.99', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '6.99', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '6.99', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 6.99', 'plan contract report mismatch');

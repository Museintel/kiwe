...
(async () => {
  ...
  assert(entry.contractVersion === '7.18', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '7.18', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '7.18', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 7.18', 'plan contract report mismatch');

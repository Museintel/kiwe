...
(async () => {
  ...
  assert(entry.contractVersion === '7.14', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '7.14', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '7.14', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 7.14', 'plan contract report mismatch');

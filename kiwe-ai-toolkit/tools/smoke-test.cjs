...
(async () => {
  ...
  assert(entry.contractVersion === '7.17', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '7.17', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '7.17', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 7.17', 'plan contract report mismatch');

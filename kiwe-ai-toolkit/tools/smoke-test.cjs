...
(async () => {
  ...
  assert(entry.contractVersion === '6.97', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '6.97', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '6.95', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 6.95', 'plan contract report mismatch');

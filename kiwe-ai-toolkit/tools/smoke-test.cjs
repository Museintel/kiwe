...
(async () => {
  ...
  assert(entry.contractVersion === '7.06', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '7.06', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '7.06', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 7.06', 'plan contract report mismatch');

...
(async () => {
  ...
  assert(entry.contractVersion === '7.08', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '7.08', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '7.08', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 7.08', 'plan contract report mismatch');

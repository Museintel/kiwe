...
(async () => {
  ...
  assert(entry.contractVersion === '7.19', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '7.19', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '7.19', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 7.19', 'plan contract report mismatch');

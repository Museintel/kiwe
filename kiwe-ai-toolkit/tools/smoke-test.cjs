...
(async () => {
  ...
  assert(entry.contractVersion === '7.10', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '7.10', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '7.10', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 7.10', 'plan contract report mismatch');

...
(async () => {
  ...
  assert(entry.contractVersion === '6.91', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '6.91', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '6.91', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 6.91', 'plan contract report mismatch');

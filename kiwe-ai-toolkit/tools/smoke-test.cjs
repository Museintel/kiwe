...
(async () => {
  ...
  assert(entry.contractVersion === '6.98', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '6.98', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '6.98', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 6.98', 'plan contract report mismatch');

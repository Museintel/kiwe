...
(async () => {
  ...
  assert(entry.contractVersion === '6.85', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '6.85', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '6.85', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 6.85', 'plan contract report mismatch');

...
(async () => {
  ...
  assert(entry.contractVersion === '6.67', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '6.67', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '6.67', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 6.67', 'plan contract report mismatch');

...
(async () => {
  ...
  assert(entry.contractVersion === '6.77', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '6.77', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '6.77', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 6.77', 'plan contract report mismatch');

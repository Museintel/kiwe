...
(async () => {
  ...
  assert(entry.contractVersion === '7.09', 'entry contract mismatch');
  ...
  assert(manifest.entry.contractVersion === '7.09', 'manifest contract mismatch');
  ...
  assert(plan.contractVersion === '7.09', 'plan contract mismatch');
  assert(plan.startResponse.mustReport === 'SeamFlow contract: 7.09', 'plan contract report mismatch');

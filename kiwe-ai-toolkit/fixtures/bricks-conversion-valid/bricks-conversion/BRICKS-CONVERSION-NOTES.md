...
- Kiwe capability attributes: the Search launcher, theme toggle, wishlist/save control, query-template marker, and binding marker are preserved as Bricks element attributes.

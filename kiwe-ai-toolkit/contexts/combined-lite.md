...
- Do not put anonymous pixel values directly in importable `theme.css`. Write `padding: var(--kiwe-space-md)`, `border-radius: var(--kiwe-radius-xl)`, `border-width: var(--dsa-geometry-dock-border, thin)`, and `box-shadow: var(--kiwe-shadow-md)` rather than `padding: 24px`, `border-radius: 18px`, `border: 1px solid`, or `box-shadow: 0 18px 48px ...`.

...
final class Design_Context_Service {
	...
	public function context( array $args = [], bool $administrator = false ): array {
		...
		return [
			...
			'ideationContract' => [
				...
				'siteDataRequirement' => [
					'askForSiteGraphWhen' => 'The requested draft needs real products, posts, custom content, media, menus, taxonomies, custom fields, or dynamic binding evidence and the attached context does not contain that catalog.',
					'doNotRequireSiteGraphFor' => 'A framework-neutral concept using only complete owner facts and honest placeholders.',
					'productionRule' => 'Use real catalog records for preview evidence; keep production collections dynamic and preserve stable source selectors for later binding.',
				],
	...
	private function business_identity( bool $administrator ): array {
		...
		return [
			...
			'dynamicTags' => [
				...
				'businessStory' => '{kiwe_business_story}',
				'mission' => '{kiwe_business_mission}',
				...
				'regulatory' => [
					...
					'showManufacturingAddress'=>'{kiwe_show_manufacturing_address}',
				],
				'contentPreferences' => [ 'showBlogRail'=>'{kiwe_show_blog_rail}', 'highlightBestsellers'=>'{kiwe_highlight_bestsellers}' ],
				'productNutritionImage' => '{kiwe_product_nutrition_image}',
	...
	private function commerce_context( array $graph, array $products ): array {
		...
		return [
			...
			'dynamicAuthority' => [
				'productRecord' => 'WooCommerce product query context; never copy sampled values into production regions',
				'bricksDynamicTags' => [
					'title' => '{post_title}',
					'link' => '{post_url}',
					'longDescription' => '{post_content}',
					'shortDescription' => '{woo_product_excerpt}',
					'featuredImage' => '{featured_image}',
					'images' => '{woo_product_images}',
					'galleryImages' => '{woo_product_gallery_images}',
					'price' => '{woo_product_price}',
					'regularPrice' => '{woo_product_regular_price}',
					'salePrice' => '{woo_product_sale_price}',
					'sku' => '{woo_product_sku}',
					'stock' => '{woo_product_stock}',
					'stockStatus' => '{woo_product_stock_status}',
					'rating' => '{woo_product_rating}',
					'nutritionImage' => '{kiwe_product_nutrition_image}',
				],

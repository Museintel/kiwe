...
final class Settings {
	...
	public function defaults(): array {
		return [
				...
				'secure'              => [
					'enabled'             => false,
					'protection_profile'  => 'monitor',
					'auto_logout_enabled' => false,
					'auto_logout_minutes' => 30,
					'auto_logout_roles'   => [],
					'trusted_proxy_cidrs' => '',
					'schema_integrity_guard_enabled' => false,
					'seo_spam_410_enabled' => false,
					'harden_public_rest_users' => false,
					'security_headers_enabled' => false,
					'image_resource_guard_enabled' => false,
					'image_big_size_threshold' => 2560,
					'image_max_dimension' => 12000,
					'image_max_megapixels' => 40,
				],
				'ai'                  => [

...
final class Seam_Token_Service {
	public static function universal_tokens(): array {
		$tokens = [
			...
			self::token( 'border-width-hairline', '1px', 'component', 'Default fine border width for cards, chips, and rails.', '--border-width-hairline' ),
			self::token( 'border-width-strong', '2px', 'component', 'Emphasized border width for selected states and high-contrast separators.', '--border-width-strong' ),
			...
			self::token( 'content-width-compact', '440px', 'layout', 'Compact card, aside, form, and narrow feature width.', '--content-width-compact' ),
			self::token( 'content-width-readable', '680px', 'layout', 'Readable editorial copy and medium feature width.', '--content-width-readable' ),

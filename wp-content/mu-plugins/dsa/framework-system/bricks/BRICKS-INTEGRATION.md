...
The main orchestrator is `Bricks\Html_To_Bricks_Converter::convert( $html_string, $options )`, which parses HTML/CSS/JS, creates Bricks elements, processes global classes, extracts variables, creates CSS/HTML code elements where needed, and validates the generated structure.

Lead implication for Kiwe Framework:

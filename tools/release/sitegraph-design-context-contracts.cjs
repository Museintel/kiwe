...
check('ideate discovery artifact has a strict v3 schema and creative boundary', ideateDiscoverySchema.properties.schema.const === 'kiwe.ideate-discovery.v3' && ideateDiscoverySchema.required.includes('designContextCoverage') && ideateDiscoverySchema.required.includes('approval') && ideateDiscoverySchema.properties.creativeBoundary.properties.frameworkNeutral.const === true);

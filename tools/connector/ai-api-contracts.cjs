...
check('Package manifest includes API key, theme package, inspection, and staging executor files', manifest.includes('includes/AI/Access_Key_Service.php') && manifest.includes('includes/Rest/AI_Access_Controller.php') && manifest.includes('includes/Theme/Theme_Package_Service.php') && manifest.includes('includes/AI/Site_Introspection_Service.php') && manifest.includes('includes/AI/Staging_Execution_Service.php') && manifest.includes('ui-system/theme-package.schema.json'));
